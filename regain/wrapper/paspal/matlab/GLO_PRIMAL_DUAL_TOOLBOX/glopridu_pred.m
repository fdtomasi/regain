function pred = glopridu_pred(model,Xtest,Ytest,err_type)
%Predicts outputs on test set
%   [PRED] = GLOPRIDU_PRED(MODEL,XTEST) Given MODEL from GLOPRIDU_KCV or a struct 
...
%
%   [PRED] = GLOPRIDU_PRED(MODEL,XTEST,YTEST,ERR_TYPE) Given MODEL from 
%   GLOPRIDU_KCV predicts outputs and computes mean squared errror for test set XTEST. 
...
%
%   See also GLOPRIDU_LEARN, GLOPRIDU_KCV PREDICTION_ERROR
%
