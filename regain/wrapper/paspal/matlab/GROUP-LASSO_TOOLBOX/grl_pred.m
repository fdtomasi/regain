function pred = grl_pred(model,Xtest,Ytest,err_type)
%Predicts outputs on test set
%   [PRED] = GRL_PRED(MODEL,XTEST) Given MODEL from GRL_KCV or a struct 
...
%
%   [PRED] = GRL_PRED(MODEL,XTEST,YTEST,ERR_TYPE) Given MODEL from 
%   GRL_KCV predicts outputs and computes mean squared errror for test set XTEST. 
...
% 
%   See also GRL_LEARN, GRL_KCV, PREDICTION_ERROR.
%
