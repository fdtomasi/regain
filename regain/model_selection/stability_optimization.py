...
from sklearn.model_selection import GridSearchCV, ParameterGrid, StratifiedShuffleSplit, ShuffleSplit
...
class GraphicalModelStabilitySelection(GridSearchCV):
    def __init__(
        ...
        self.param_grid = _change_parameters(param_grid)
...
#             new_params[key] = [1 / v for v in np.sort(value)]
    ...
    def _format_results(self, candidate_params, scorers, n_splits, out):
        ...
        print(monotonized_instabilities)
...
#         super().__init__(
#             estimator=estimator, scoring=scoring, n_jobs=n_jobs, iid=iid,
#             refit=refit, cv=StratifiedShuffleSplit(
#                 n_splits=n_repetitions,
#                 train_size=sampling_size), verbose=verbose,
